...
contract ProjectStarterLaunchPad is Ownable, constructorLibrary, ReentrancyGuard {
    ...
    function setup() public onlyOwner {
        ...
        NAME_OF_PROJECT = "Test"; // name of the project to do IDO of

        token = IERC20(0xB7809aDa6ef0CB220886C8A8D997eab72BECBE4d); //token to ido
        BUSDToken = IERC20(0xb883C5E72AC27c5f0B8A5233C6b9c8cf034C5371);

        decimals = 18; //decimals of ido token (no decimals)

        numberOfIdoTokensToSell = 45000000; //No decimals
        tokenPriceInBUSD = 1 ether; //18 decimals

        maxCap = numberOfIdoTokensToSell * tokenPriceInBUSD; //18 decimals

        saleStartTime = block.timestamp; //main sale start time

        saleEndTime = block.timestamp + 1 days; //main sale end time
        ...
        maxAllocaPerUserTierOne = 50000 ether;
        maxAllocaPerUserTierTwo = 30000 ether;
        maxAllocaPerUserTierThree = 10000 ether;
        ...
        vestingUnlockTimes = [saleEndTime];
