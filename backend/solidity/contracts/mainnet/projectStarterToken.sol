...
contract ProjectStarter is ERC20, Ownable {
    ...
    address payable public _stakingContract;
    ...
    uint32 public stakingFeeSell = 500;
    uint32 public burnFeeSell = 200;
    uint32 public stakingFeeBuy = 0;
    uint32 public burnFeeBuy = 0;
    ...
    constructor(
    ...
    ) public ERC20("Project Starter", "PSR") {

        excludeFromFee(0x0B6c8fc902b05Ef70E6D65d863311EE35Ba74713, true);
        ...
        pinkAntiBot.setTokenOwner(0x0B6c8fc902b05Ef70E6D65d863311EE35Ba74713);

        uniswapV2Router = _uniswapV2Router;

        _mint(0x0B6c8fc902b05Ef70E6D65d863311EE35Ba74713, 100000000 * (10 ** decimals()) );
    }
    

    function setStakingContract(address stakingContract) public onlyOwner {
        _stakingContract = payable(stakingContract);
        excludeFromFee(stakingContract, true);
    }
    ...
    */
    function _transfer(
        ...
        if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to] && !_feesDisabled) {
            ...
            if ( _isSell(from, to) ){
                ...
                burnAmount = calculateTokenFee(
                    amount,
                    feeDecimals,
                    burnFeeSell
                );
                stakingAmount = calculateTokenFee(
                    amount,
                    feeDecimals,
                    stakingFeeSell
                );
            ...
            super._transfer(from, _stakingContract, stakingAmount);
    ...
    */
    ...
    function setStakingFeeSell(uint32 newFee)
        public
        onlyOwner
    {
        stakingFeeSell = newFee;
    }

    function setBurnFeeSell(uint32 newFee)
        public
        onlyOwner
    {
        burnFeeSell = newFee;
    ...
    function setStakingFeeBuy(uint32 newFee)
        public
        onlyOwner
    {
        stakingFeeBuy = newFee;
    }

    function setBurnFeeBuy(uint32 newFee)
        public
        onlyOwner
    {
        burnFeeBuy = newFee;
    ...
    function updateFeeDisabled(bool value)
        public
        onlyOwner
    {
        _feesDisabled = value;
    ...
    function updatePauseStatus(bool value) public onlyOwner {
        _paused = value;
    }
    ...
    function updateRouter( address router) public onlyOwner {
    ...
    function setEnableAntiBot(bool _enable) public onlyOwner {
        antiBotEnabled = _enable;
    }

    function setPinkAntiBot_(address pinkAntiBot_) public onlyOwner {
        pinkAntiBot = IPinkAntiBot(pinkAntiBot_);
